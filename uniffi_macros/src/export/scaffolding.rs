...
use crate::util::{create_metadata_items, try_metadata_value_from_usize, type_name, MetadataItems};
...
impl ScaffoldingBits {
    ...
    fn gen_function_meta_static_var(&self, sig: &Signature, mod_path: &str) -> syn::Result<TokenStream> {
