...
use crate::util::{
    create_metadata_items, tagged_impl_header, type_name, AttributeSliceExt, CommonAttr, MetadataItems,
};
...
pub(crate) fn interface_meta_static_var(ident: &Ident, module_path: &str) -> syn::Result<TokenStream> {
    let name = type_name(ident);
