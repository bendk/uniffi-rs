...
swift -I ${WORK_DIR} -L ${WORK_DIR} -luniffi_fixture_version_mismatch -luniffi_fixture_version_mismatch_swift -Xcc -fmodule-map-file=${WORK_DIR}/fixture_version_mismatchFFI.modulemap ${WORK_DIR}/fixture_version_mismatch.swift
